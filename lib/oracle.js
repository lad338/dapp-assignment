import CronosOracle from '../contracts/cronos-oracle.json' assert { type: 'json' }
import Provider from '../config/web3-provider.json' assert { type: 'json' }
import { stringPriceToNumber } from './string-util.js'
...
const btcUsdPrice = async () => {
    ...
    return stringPriceToNumber(rawResult, decimal)
}
