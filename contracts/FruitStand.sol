...
contract FruitStand {
    ...
    //accessing mapping has lower cost than array
    mapping (uint => uint) fibNums;

    //calculate the 300 used fib numbers on construction using bottom up method which has lower cost than using binet's formula
