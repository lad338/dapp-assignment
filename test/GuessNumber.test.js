...
describe('Guess Number contract', () => {
    ...
    describe('Deployment', () => {
        ...
        it('should set the correct nonceNumHash', async () => {
            ...
            expect(await hardhatGuessNumber.nonceNumHash()).to.equal(
                nonceNumHash
            )
        })
    ...
    describe('Successful guesses', () => {
        ...
        it('should have the correct sum of balance after players have guessed', async () => {
            ...
            await hardhatGuessNumber
                .connect(player1)
                .guess(321, { value: deposit })

            await hardhatGuessNumber
                .connect(player2)
                .guess(123, { value: deposit })
        ...
        it('should emit players full after reaching players limit', async () => {
            ...
            await hardhatGuessNumber
                .connect(player1)
                .guess(111, { value: deposit })

            await hardhatGuessNumber
                .connect(player2)
                .guess(222, { value: deposit })

            await expect(
                hardhatGuessNumber
                    .connect(player3)
                    .guess(333, { value: deposit })
        ...
        it('should revert if nonce is incorrect for nonceHash', async () => {
            ...
            await expect(
                hardhatGuessNumber
                    .connect(host)
                    .reveal(
                        ethers.utils.formatBytes32String('INCORRECT_NONCE'),
                        number
                    )
    ...
    describe('Successful reveal', () => {
        ...
        it('should pay the 2 winners if there is 2 winner', async () => {
            ...
            await hardhatGuessNumber
                .connect(player1)
                .guess(122, { value: deposit })
            await hardhatGuessNumber
                .connect(player2)
                .guess(124, { value: deposit })
            await hardhatGuessNumber
                .connect(player3)
                .guess(333, { value: deposit })
        ...
        it('should pay every players if the host is not using a number in range', async () => {
            ...
            await hardhatGuessNumber
                .connect(player1)
                .guess(999, { value: deposit })
            await hardhatGuessNumber
                .connect(player2)
                .guess(0, { value: deposit })
            await hardhatGuessNumber
                .connect(player3)
                .guess(250, { value: deposit })
            await hardhatGuessNumber
                .connect(player4)
                .guess(750, { value: deposit })
